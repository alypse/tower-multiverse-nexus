...
exports.LAB_GROUPS = exports.LabValues = exports.MAX_INTEREST_LEVELS = exports.ALL_LABS = exports.maxLevel = exports.LABS = void 0;
const labs_json_1 = __importDefault(require("../data/labs.json"));
/**
 ...
 */
exports.LABS = Object.freeze(Object.entries(labs_json_1.default).reduce((labMap, [name, lab]) => {
    // eslint-disable-next-line no-param-reassign
    labMap[name] = Object.freeze(Object.keys(lab)
        .filter(level => lab[level].DURATION !== null && lab[level].DURATION !== undefined)
 ...
 */
const maxLevel = (labName) => {
    const lab = exports.LABS[labName];
    if (!lab)
        return 0;
 ...
 */
exports.ALL_LABS = Object.freeze(Object.keys(exports.LABS));
/**
 * @constant MAX_INTEREST_LEVELS - A map of Max Interest lab levels to its value
 */
exports.MAX_INTEREST_LEVELS = Object.freeze({
    0: 50,
    1: 100,
    2: 200,
    3: 300,
...
const maxInterest = (level) => exports.MAX_INTEREST_LEVELS[level] || 50;
const levelToMultiplier = (scale, base = 1) => (level) => base + level * scale;
const levelToAddition = (scale, base = 0) => (level) => base + level * scale;
/**
 ...
 */
exports.LabValues = Object.freeze({
