...
exports.totalSpawns = exports.waveSpawns = exports.SPAWN_THRESHOLDS = void 0;
 ...
 */
exports.SPAWN_THRESHOLDS = Object.freeze([
    0,
    1,
    3,
    6,
 ...
 */
const waveSpawns = (wave, enemyBalance) => {
    // ignores protectors
    let spawnRate;
    let fastRate;
    let tankRate;
 ...
 */
const totalSpawns = (wave, enemyBalance) => {
    const total = {
        spawns: 0,
        basic: 0,
        fast: 0,
    ...
    for (let threshold = 0; threshold < exports.SPAWN_THRESHOLDS.length; threshold += 1) {
        const thresholdWave = exports.SPAWN_THRESHOLDS[threshold];
        const cutoffWave = Math.min(thresholdWave, wave);
        const spawnsForThreshold = (0, exports.waveSpawns)(cutoffWave, enemyBalance);
...
exports.totalSpawns = totalSpawns;
