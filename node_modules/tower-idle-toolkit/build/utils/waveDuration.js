...
exports.getRealWaveTime = exports.getInGameWaveTime = exports.getWaveCooldown = exports.isBossWave = exports.TOURNAMENT_COOLDOWN_MODIFIER = exports.BOSS_WAVE_COOLDOWN = exports.NORMAL_WAVE_COOLDOWN = exports.WAVE_DURATION = exports.getRealGameSpeed = void 0;
const cards_1 = require("../constants/cards");
/**
 ...
 */
const getRealGameSpeed = (displayedGameSpeed, introSprint = false) => {
    let realGameSpeed = 1;
...
exports.getRealGameSpeed = getRealGameSpeed;
/**
 ...
 */
exports.NORMAL_WAVE_COOLDOWN = 9;
/**
 ...
 */
const isBossWave = (wave) => wave % 10 === 0;
exports.isBossWave = isBossWave;
/**
 ...
 */
const getWaveCooldown = (wave, waveAccelerator, tournament) => {
    const waModifier = 1 - (cards_1.WAVE_ACCELERATOR_CARD[waveAccelerator] || 0) / 100;
    const baseCooldown = (0, exports.isBossWave)(wave)
        ? exports.BOSS_WAVE_COOLDOWN
        : exports.NORMAL_WAVE_COOLDOWN;
    const tournamentModifier = tournament ? exports.TOURNAMENT_COOLDOWN_MODIFIER : 1;
    return baseCooldown * waModifier * tournamentModifier;
};
exports.getWaveCooldown = getWaveCooldown;
/**
 ...
 */
const getInGameWaveTime = (wave, waveAccelerator, tournament) => {
    return exports.WAVE_DURATION + (0, exports.getWaveCooldown)(wave, waveAccelerator, tournament);
};
exports.getInGameWaveTime = getInGameWaveTime;
/**
 ...
 */
const getRealWaveTime = ({ wave, displayedGameSpeed, introSprint, waveAccelerator, tournament, }) => {
    const gameSpeed = (0, exports.getRealGameSpeed)(displayedGameSpeed, introSprint);
    const time = (0, exports.getInGameWaveTime)(wave, waveAccelerator, tournament);
    return time / gameSpeed;
};
exports.getRealWaveTime = getRealWaveTime;
