...
export const PermaCalculator = ({props}) => {
    ...
    const checkBHPermanent = (waves) => {
      ...
      while (waveCountBH > 0) {
        totalWavesTime += getInGameWaveTime(
          waveCountBH,
          waveAcceleratorCard,
          isTournament,
        );
      ...
      const cdReductionTotal =
        totalWavesTime + packageCount * galaxyCompressorEffect;
      const bhActivations = totalWavesTime / props.bhCooldown;
      const bhUptime =
        bhActivations *
        BH_DURATION(bhDurationStones, bhDurationSubstat, bhPerk);
      return (
        (cdReductionTotal / totalWavesTime) * bhUptime >=
        props.bhCooldown * bhActivations
      );
    };
    ...
    const checkGTPermanent = (waves) => {
      ...
      return (
        (cdReductionTotal / totalWavesTime) * gtUptime >=
        props.gtCooldown * gtActivations
      );
    };
    ...
    return (
        <div className="main">
            ...
            <div className="controlGroup">
                    <InputFromArrayShowValue 
                        controlName="GT Dur Stones"
                        stateVariable={gtDurationStonesLevel}
            ...
            <div className="controlGroup">
                    <InputFromArrayShowValue 
                        controlName="BH Dur Stones"
                        stateVariable={bhDurationStones}
                        stateSetter={setBHDurationStones}/>
                    <DropdownFromObjectShowKey 
